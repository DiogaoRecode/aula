Funcionalidade: Frete Gratis para as regiões Norte e Nordeste
  ...
  Cenário: Teste de CEP válido mas inexistente
    ...
    Então o cliente deve ver a mensagem "Não existe CEP com este endereço!"

  Cenário: Resposta do servidor 200
    Quando ele inserir o cep e o servidor der a resposta 200
    Então o cliente deve ver a mensagem "Consulta realizada com SUCESSO!"

Cenário: Resposta do servidor diferente de 200
    Quando ele inserir o cep e o servidor der a resposta diferente de 200
    Então o cliente deve ver a mensagem "Erro no servidor! Verifique se o endereço realmente existe no sistema!"